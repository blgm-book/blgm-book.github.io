...
#### **Chapter 1** - *Bayesian latent Gaussian models*

Birgir Hrafnkelsson and Haakon Bakka

- [<font size="3">Section 4 - Code (DUMMY)</font> ](https://sites.google.com/view/rates-antarctica/home)
 
#### **Chapter 2** - *A review of Bayesian modelling in glaciology*

Giri Gopalan, Andrew Zammit-Mangion, and Felicity McCormack

- [<font size="3">Section 3 - Code (R)</font> ](https://sites.google.com/view/rates-antarctica/home)
- [<font size="3">Section 4 - Code (DUMMY)</font> ](https://sites.google.com/view/rates-antarctica/home)
...
- [<font size="3">Code and data - GitHub repository (MISSING)</font> ](https://github.com/hjordislb/BHM2020)

#### **Chapter 6** - *Improving numerical weather forecasts by Bayesian hierarchical modelling*

Joshua Lovegrove and Stefan Siegert

- [<font size="3">Code and data - GitHub repository (DUMMY)</font> ](https://github.com/hjordislb/BHM2020)

#### **Chapter 7** - *Bayesian latent Gaussian models for high-dimensional spatial extremes*

Arnab Hazra, Raphaël Huser, and Árni V. Jóhannesson

- [<font size="3"> Data </font> ](https://gpm.nasa.gov/data-access/downloads/trmm)
- [<font size="3"> Code (R) </font> ](https://github.com/arnabstatswithR/max_and_smooth)
